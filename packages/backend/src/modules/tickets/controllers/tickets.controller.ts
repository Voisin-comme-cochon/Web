...
import { ResponseTicketDto, StatusTicketDto } from './dto/tickets.dto';
...
export class TicketsController {
    ...
    async getUserById(@Query() query: StatusTicketDto): Promise<ResponseTicketDto[]> {
        const tickets = await this.ticketsService.getTickets(query.status);
