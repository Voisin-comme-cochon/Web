...
export default function ChatPanelWithApi({ onClose }: { onClose: () => void }) {
    ...
    console.log('ChatPanel: Données utilisateur:', { user, neighborhoodId });
    ...
    const handleSendMessage = async () => {
        ...
        console.log('ChatPanel: Envoi de message:', { message: newMessage, groupId: chat.activeConversation });
        const success = await chat.sendMessage(newMessage, chat.activeConversation);
        console.log('ChatPanel: Résultat envoi:', success);
    ...
    // Debug: Log des messages quand ils changent
    useEffect(() => {
        if (chat.activeConversation) {
            console.log('ChatPanel: Messages mis à jour pour le groupe', chat.activeConversation, ':', activeMessages);
        }
    }, [chat.activeConversation, activeMessages]);
                ...
                {chat.activeConversation ? (
                    <>
                        ...
                        <div className="flex items-center flex-1 ml-1">
                            <div className="w-8 h-8 rounded-full overflow-hidden mr-2 relative bg-secondary">
                                {/* Avatar placeholder */}
                                    ...
                                    {message.groupId &&
                                        ...
                                        message.userId !== user?.id && (
                                            <div className="flex items-center mb-1 ml-2">
                                                <div className="w-5 h-5 rounded-full overflow-hidden mr-1 bg-secondary">
                        ...
                        {chat.loading && filteredConversations.length === 0 ? (
                            ...
                            filteredConversations.map((conversation) => (
                                ...
                                >
                                    <div className="flex items-center">
                                        <div className="relative">
                                            <div className="w-12 h-12 rounded-full overflow-hidden mr-3 bg-secondary">
                                                <div className="w-full h-full flex items-center justify-center text-white font-bold">
