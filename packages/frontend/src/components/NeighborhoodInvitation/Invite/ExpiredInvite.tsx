...
export function ExpiredInvite({ neighborhoodName, inviterName }: ExpiredInviteProps) {
    return (
            ...
            <Card className="w-full max-w-md">
                <CardContent className="p-6 text-center">
                    ...
                    <p className="text-[#1a2a41]/70 mb-6">
                        {neighborhoodName && inviterName
                            ? `L'invitation de ${inviterName} pour rejoindre le quartier "${neighborhoodName}" a expiré.`
