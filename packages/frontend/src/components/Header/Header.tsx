        ...
        <header className="flex items-center justify-between w-full p-4 bg-white">
            <div className="flex items-center">
                ...
                <div className="flex ml-16">
                    <h1 className="text-black hover:underline cursor-pointer">Pourquoi nous</h1>
                    <h1 className="text-black ml-8 hover:underline cursor-pointer">Voir votre quartier</h1>
                </div>
            </div>
