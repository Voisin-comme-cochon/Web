...
export default function LandingPage() {
    ...
    return (
        <div className="flex items-center justify-center flex-col w-full bg-background overflow-x-hidden">
            ...
            <div
                className={
                    "h-lvh w-full bg-white flex justify-center items-center flex-col"
                }
                id={"why-vcc"}
            >
                <div
                    className={"w-full flex ml-16 justify-center items-start flex-col mb-8"}
                >
                    <p className={"text-5xl mb-2"}>
                        <span className={"text-orange font-bold"}>Pourquoi</span> voisin
                        comme cochon
                    </p>
                    <p className={"text-2xl w-1/2"}>
                        Nous proposons divers services afin de fluidifier les intéractions
                        entre voisins
                    </p>
                </div>
            ...
            <div
                className={
                    "h-lvh w-full bg-foreground flex justify-center items-center flex-col"
                }
                id={"discover-your-neighborhood"}
            >
                <div
                    className={"w-full ml-16 flex justify-center items-start flex-col mb-8"}
                >
                    <p className={"text-5xl text-white mb-2"}>
                        <span className={"text-orange font-bold"}>Découvrez</span> votre
                        quartier
                    </p>
                    <p className={"text-2xl text-white w-1/2"}>
                        Avec toutes les personnes qui s'y trouvent
                    </p>
                </div>
